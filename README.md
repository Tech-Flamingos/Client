...
Ash Uppal, Brenda Jow, Martin Hansen, Steve Gant
...
2. A text-based adventure game using ChatGPT where you will develop a storyline and include challenges which will change the outcome of the story every time.
...
- As a user I want to
  ...
  - sign up with my name and password
  - sign in so the server knows i am a user and knows my name.
  - choose one out of multiple option to continue the story.
  - I want to read a new unique story each time
  - at the end I want to get the whole story back so that I can read it in one go. (stretch goal)

- As a admin I want to

  - sign up with my name and password with admin role
  - sign in so the server knows i am a user and knows my name.
